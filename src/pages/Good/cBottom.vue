...
<template>
  <div class="container-water-fall water-content">
    ...
    <waterfall :col="col"
               ...
               @loadmore="loadmore">
      <template>
          <div class="oneImg" style="margin: 10px 0 20px 0;width:345px;height:192px;">
            <img src="../../images/nb.png" alt="" style="width:345px;height:192px;border-radius: 15px;">
        </div>
        <div class="cell-item"
...
export default {
  ...
  computed: {
    itemWidth() {
      return 133 * 0.5 * (document.documentElement.clientWidth / 750);
    },
    gutterWidth() {
      return 10 * 0.5 * (document.documentElement.clientWidth / 750);
    }
  },
  methods: {
    reset() {
